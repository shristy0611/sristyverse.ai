...
import { Layout, Brain, MessageCircle, FileText, BarChart, Check, Send, Mail, Phone, MapPin, Users, Code, Shield } from 'lucide-react';
      ...
      <div className="pt-16">
        ...
        <section id="solutions" className="min-h-screen snap-start flex items-center relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            ...
            <SolutionsSlider solutions={solutions} onSelect={() => {}} />
          </div>
        </section>
